    ...
    namespace msr
{
    namespace airlib
    {
        ...
        MultirotorRpcLibClient* MultirotorRpcLibClient::moveByMotorPWMBatchAsync(std::vector<float>& front_right_pwm, std::vector<float>& rear_left_pwm, std::vector<float>& front_left_pwm, std::vector<float>& rear_right_pwm, float duration,
                                                                        const std::vector<std::string>& vehicle_names)
        {
            pimpl_->last_future = static_cast<rpc::client*>(getClient())->async_call("moveByPWMBatch", front_right_pwm, rear_left_pwm, front_left_pwm, rear_right_pwm, duration, vehicle_names);
            return this;
        }
