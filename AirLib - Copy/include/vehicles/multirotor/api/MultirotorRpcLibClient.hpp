...
namespace airlib
{
    ...
    public:
        ...
        MultirotorRpcLibClient* moveByMotorPWMBatchAsync(std::vector<float>& front_right_pwm, std::vector<float>& rear_left_pwm, std::vector<float>& front_left_pwm, std::vector<float>& rear_right_pwm, float duration,
